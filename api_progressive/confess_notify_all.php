...
if($_POST['auth_key'] != "laksfjifdvilwerumfb" || !isset($_POST['confess'])  || !isset($_POST['name'])  )
{
...
$message = $_POST['confess'] ;
$title = "Posted by ". $_POST['name'] ;
...
$sql = "select token_zika from pci_token  " ;
